...
<main>
    <div class="container-fluid px-4">
        <h3 class="mt-4 mb-4">Tambah Kategori</h3>
        <div class="card mb-4">
            <div class="card-body">
                <form action="/kategori/store" method="post">
                    <div class="mb-3">
                        <label for="inputKategori" class="form-label">Kategori <span class="text-danger">*</span> </label>
                        <input type="text" name="nama_kategori" value="<?= old('nama_kategori') ?>" class="form-control" id="inputKategori" placeholder="Nama Kategori...">
